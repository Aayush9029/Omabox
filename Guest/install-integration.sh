...
for source in usr/local/libexec/omabox-desktop-environment.sh usr/local/libexec/omabox-display-sync.py usr/local/bin/omabox-start-desktop usr/local/share/omabox/runtime.lua 'etc/systemd/system/mnt-omabox\x2dconfig.mount'; do
