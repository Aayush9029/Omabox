...
Choose **Set Up Omarchy**, complete Linux setup, then use **Start Omarchy**. CPU and memory changes apply after shutdown; disk capacity is fixed after installation. App updates preserve your desktop.

- **⌃⌥⌘K** opens the running or paused VM's menu; plain **⌘K** goes to Linux.
